...
from utils.data_md import *
from utils.trainer import Trainer

from models.app_md import App2
import nltk
...
bceloss = nn.BCEWithLogitsLoss(pos_weight=torch.Tensor([2,2,2,2,2]).to(torch.device('cuda')))
nll=nn.NLLLoss()
...
trainer.predict(train_loader,'predictions/train_md',csv_writer)
trainer.predict(val_loader,'predictions/val_md',csv_writer)
trainer.predict(test_loader,'predictions/test_md',csv_writer)
